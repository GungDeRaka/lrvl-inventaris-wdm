...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.siswa.driver' => 'string',
            'auth.guards.siswa.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.siswas.driver' => 'string',
            'auth.providers.siswas.model' => 'string',
            ...
            'auth.passwords.siswas.provider' => 'string',
            'auth.passwords.siswas.table' => 'string',
            'auth.passwords.siswas.expire' => 'integer',
            'auth.passwords.siswas.throttle' => 'integer',
            ...
            'filesystems.links./home/gungderaka/laravel-project/smk-widiatmika-inventaris/public/storage' => 'string',
...
'auth.guards.web.provider','auth.guards.siswa.driver','auth.guards.siswa.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.siswas.driver','auth.providers.siswas.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
'auth.passwords.users.throttle','auth.passwords.siswas.provider','auth.passwords.siswas.table','auth.passwords.siswas.expire','auth.passwords.siswas.throttle',
...
'filesystems.links./home/gungderaka/laravel-project/smk-widiatmika-inventaris/public/storage','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'signed','throttle','verified','cek.jam.kerja',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','barang.index','laporan.transaksi',
'transaksi.cetak','user.index','kategori.index','ruangan.index','siswa.index',
'rab.index','profile.edit','profile.update','profile.destroy','siswa.login',
'siswa.','siswa.logout','siswa.password.request','siswa.password.email','siswa.password.reset',
'siswa.password.update','siswa.dashboard','siswa.profil','login',
...
'components.dropdown-link','components.input-error','components.input-label','components.layouts.app','components.layouts.siswa',
...
'components.text-input','dashboard','laporan.struk_transaksi_pdf','laporan.transaksi_pdf','layouts.app',
'layouts.guest','layouts.navigation','livewire.barang.index','livewire.dashboard.index','livewire.kategori.index',
'livewire.notifications.bell','livewire.rab.create','livewire.rab.index','livewire.ruangan.index','livewire.siswa.dashboard',
'livewire.siswa.index','livewire.siswa.profil','livewire.user.index','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','siswa.auth.forgot-password','siswa.auth.login','siswa.auth.reset-password',
...
'SAIL_XDEBUG_MODE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
