 {{-- //TODO tambahin algoritma pengecekan apakah kode barang udah pernah dibuat atau belum. kalau belum, ijinkan. kalau udh, beri pop-up pertanyaan, tambahkan ke stok barang yang sudah ada --}}
             ...
             <tbody>
                 @forelse ($barangs as $barang)
                     <tr class="hover:bg-gray-300 ">
                         ...
                         <td wire:click="$set('detailBarangId', {{ $barang->id }})"
