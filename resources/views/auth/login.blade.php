...
<body class="font-sans text-gray-900 antialiased relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0">
        ...
        {{--  Overlay Gradasi --}}
        <div class="absolute inset-0 bg-gradient-to-r from-purple-800 to-[#871a77] opacity-80"></div>
    </div>

    {{--  Konten Utama --}}
    <div class="relative z-10 flex items-center justify-center w-full min-h-screen">
        <div class="bg-white/90 backdrop-blur-sm shadow-2xl rounded-lg flex w-full max-w-5xl">

            {{-- Bagian Kiri (Form Login) --}}
            <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                <div class="flex justify-center mb-8">
                    <img src="{{ asset('logo.jpg') }}" alt="Logo SMK Widiatmika" class="h-24">
                </div>
            ...
            <div class="hidden md:flex w-1/2 bg-primary/90 text-white p-12 flex-col justify-center items-center rounded-r-lg">
